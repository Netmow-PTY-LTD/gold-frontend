  ...
  useEffect(() => {
    if (fetchedProduct?.data) {
      form.reset({
        ...
        // Gold Shop Fields
        purity: fetchedProduct?.data?.purity || '916',
        gross_weight: Number(fetchedProduct?.data?.gross_weight) || 0,
        net_weight: Number(fetchedProduct?.data?.net_weight) || 0,
        making_charge_type: fetchedProduct?.data?.making_charge_type || 'fixed',
        making_charge_value: Number(fetchedProduct?.data?.making_charge_value) || 0,
        stone_weight: Number(fetchedProduct?.data?.stone_weight) || 0,
        stone_price: Number(fetchedProduct?.data?.stone_price) || 0,
      });
    }
    ...
    <div className="space-y-6 max-w-5xl mx-auto pb-6">
      ...
      <Form {...form}>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          {/* GOLD & STONE DETAILS */}
          <Card className="overflow-hidden border-2 transition-all duration-300 hover:border-amber-200 hover:shadow-lg">
            <CardHeader className="bg-gradient-to-r from-amber-50 via-yellow-50 to-amber-50 dark:from-amber-950/30 dark:via-yellow-950/30 dark:to-amber-950/30 border-b-2 border-amber-100 dark:border-amber-900 py-3 gap-0">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-0.5">Purity, weights, making charges, and stone information</p>
                </div>
              </div>
            </CardHeader>
            ...
            <CardContent className="grid gap-4 md:grid-cols-3 pb-6">
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field>
                    <FieldLabel><Gem className="w-4 h-4 inline mr-1" />Stone Weight (g)</FieldLabel>
                    <Input
                      type="number"
                      step="0.001"
                      value={field.value ?? ""}
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field>
                    <FieldLabel><Gem className="w-4 h-4 inline mr-1" />Stone Price</FieldLabel>
                    <Input
                      type="number"
                      step="0.01"
                      value={field.value ?? ""}
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field>
                    <FieldLabel>Making Charge Type</FieldLabel>
                    <Select value={field.value || ""} onValueChange={field.onChange}>
                      <SelectTrigger>
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field className="md:col-span-2">
                    <FieldLabel>Making Charge Value</FieldLabel>
                    <Input
                      type="number"
                      step="0.01"
                      value={field.value ?? ""}
